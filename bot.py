...
def main():
    ...
    app.add_handler(CallbackQueryHandler(adm_edit_country_list_callback, pattern=r"^page_adm_edit_\d+$"))
    ...
    app.add_handler(CallbackQueryHandler(adm_remove_country_list_callback, pattern=r"^page_adm_del_\d+$"))
